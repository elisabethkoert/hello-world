...
def calculateAF(x=[-1e-3,0,1e-3],z=1e-3,I_el=-290e-6):
    """
    calculate the activating function along an unmyelinated axon generated by a monopolar current source 
    ----------
    ...
    -------
    AF : array of floats
        values of the activating function at any point along the fiber.
